import { getAppointmentsForDay,getInterview,getInterviewersForDay } from "./Selecter";
...
//TESTS FOR GET INTERVIEWER FOR DAY
...
test("getInterviewerssForDay returns an array containing the correct Interviewers objects", () => {
